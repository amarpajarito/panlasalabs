...
export default function SignupPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      // TODO: Implement signup logic with backend/NextAuth
        ...
        <div className="w-full bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-[#454545] text-sm">
              Get started with PanlasaLabs today
            </p>
          </div>
          ...
          <p className="text-center text-gray-500 text-xs mt-6 leading-relaxed">
            ...
            <Link
              href="/terms"
              className="text-[#6D2323] hover:text-[#8B3030] transition-colors duration-200 underline"
            >
              Terms
            </Link>{" "}
            and{" "}
