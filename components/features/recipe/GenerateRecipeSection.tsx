...
export default function GenerateRecipeSection() {
  ...
  const isLoggedIn = false; // Public page always shows locked state

  const handleGenerate = (e: React.FormEvent) => {
    e.preventDefault();
    // TODO: Handle recipe generation with AI when backend is ready
  ...
  return (
    <section className="w-full py-16 md:py-24 bg-gradient-to-b from-[#FEF9E1]/30 to-white">
      <div className="max-w-[1512px] mx-auto px-4 sm:px-6 md:px-12 lg:px-[86px]">
        ...
        {/* Notice Badge for Non-Logged Users */}
        {!isLoggedIn && (
          ...
          {!isLoggedIn ? (
            ...
            <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg text-center">
              ...
              <p className="text-[#454545] text-base md:text-lg mb-8 max-w-2xl mx-auto">
                ...
                generation tailored to your preferences, ingredients, and
                dietary needs.
              </p>
            ...
            // Show recipe generation form if user is logged in
            <div className="bg-white rounded-2xl p-8 md:p-10 shadow-lg">
              <form onSubmit={handleGenerate} className="space-y-6">
                ...
                <div>
                  <label
                    htmlFor="ingredients"
                    className="block text-[#1a1a1a] font-semibold text-base mb-2"
                  >
                  ...
                  <p className="text-[#454545] text-xs mt-1">
                    List the ingredients you want to use, separated by commas
                  </p>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-[#6D2323] text-white px-8 py-4 rounded-lg hover:bg-[#8B3030] transition-colors duration-200 font-semibold text-lg flex items-center justify-center gap-2"
                >
                  <svg
                    className="w-6 h-6"
                    fill="none"
